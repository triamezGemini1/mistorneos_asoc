...
class MesaAsignacionService
{
    ...
    /** Filtro por evento local: solo datos de la entidad configurada (DESKTOP_ENTIDAD_ID). */
    private function entidadId(): int
    {
        return DB::getEntidadId();
    }
    ...
    public function eliminarRonda($torneoId, $ronda)
    {
        try {
            ...
            $ent = $this->whereEntidad();
            // 1. Eliminar historial de parejas de esta ronda (solo evento local)
            try {
